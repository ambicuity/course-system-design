...
1. Author an SVG in the cream + berry aesthetic (cream `#FFF7EC` paper, `#E2557A` berry strokes for primary lines, optional sage `#6FAF9E` and sunny `#F5C45E` accents for secondary detail, Inter or JetBrains Mono labels with leader lines).
