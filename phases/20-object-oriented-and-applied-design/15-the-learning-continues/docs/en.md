...
- Announcing Snowflake (a network service for generating unique ID numbers at high scale with simple guarantees) — https://goo.gl/GzVWYm
...
If you are going to interview with a company, it is a great idea to read their engineering blogs and get familiar with the technologies and systems adopted and implemented there. Engineering blogs provide invaluable insights into specific fields, and reading them regularly helps you become a better engineer.

A list of engineering blogs of well-known large companies and startups:
